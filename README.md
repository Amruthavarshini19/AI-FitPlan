...
- **Multi-Step Registration**:
  ...
  2. System checks for existing email addresses
  3. OTP is generated and sent to user's email
  4. User enters OTP for verification
  5. Account is created upon successful OTP verification
...
1. **New User**: Click "Sign Up" tab, fill form, verify email with OTP
2. **Existing User**: Use "Sign In" tab with email and password
3. **Profile Creation**: Fill fitness profile form to generate AI plans
4. **Plan Generation**: Get personalized workout and diet recommendations
5. **Profile Editing**: Use "Edit Profile" to update information and regenerate plans
